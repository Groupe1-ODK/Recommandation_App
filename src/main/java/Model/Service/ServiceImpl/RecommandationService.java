...
public class RecommandationService implements IServiceRecommandation {
	...
	public RecommandationService(RecommandationDAOInter recommandationRepository, ActiviteInter activiteRepository,
			ProfilServiceInter profilService) {
	...
	public void creer(Profil profil) {
		...
		this.recommandationRepository.creer(profil.getId(), recommandation);
	}

	@Override
	public List<Activite> liste(int utilisateurId) {
		return this.recommandationRepository
				.liste(this.profilService.obtenirProfilParUtilisateur(utilisateurId).getId());
	}
}
